...
export default function Invoices() {
  ...
  async function handleSubmit(e) {
    ...
    const publicURL = `${supabase.storage.from("invoices").getPublicUrl(filePath).data.publicUrl}`;
    ...
    <div className={styles.container}>
      ...
      {showForm && (
        <form className={styles.form} onSubmit={handleSubmit}>
          ...
          <label>
            File (PDF or Image)
            <input type="file" name="file" onChange={handleChange} accept="application/pdf,image/*" required />
          </label>
